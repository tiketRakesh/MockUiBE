...
var Message = (function () {
    ...
    Message.prototype.createMessage = function () {
        ...
        return new Promise(function (resolve, reject) {
            var _a = _this.options, pactFileWriteMode = _a.pactFileWriteMode, content = _a.content, restOptions = __rest(_a, ["pactFileWriteMode", "content"]);
            var instance = spawn_1.default.spawnBinary(pact_standalone_1.default.messagePath, [{ pactFileWriteMode: pactFileWriteMode }, restOptions], _this.__argMapping);
            var output = [];

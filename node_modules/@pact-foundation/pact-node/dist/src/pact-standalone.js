...
var config_1 = require("../standalone/config");
...
var standalone = function (platform, arch) {
    ...
    var basePath = path.join('standalone', config_1.getBinaryEntries(platform, arch).filter(function (e) { return e.type === 'ruby-standalone'; })[0].folderName, 'pact', 'bin');
    return {

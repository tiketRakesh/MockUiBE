...
var CanDeploy = (function () {
    ...
    CanDeploy.prototype.canDeploy = function () {
        ...
        var canDeployPromise = new Promise(function (resolve, reject) {
            var instance = spawn_1.default.spawnBinary(pact_standalone_1.default.brokerPath, __spreadArray([
                { cliVerb: 'can-i-deploy' }
            ], CanDeploy.convertForSpawnBinary(_this.options)), _this.__argMapping);
            var output = [];
        ...
        return promise_timeout_1.timeout(canDeployPromise, this.options.timeout).catch(function (err) {
